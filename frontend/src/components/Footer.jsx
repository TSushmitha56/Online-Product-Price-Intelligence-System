      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="md:col-span-5 space-y-4">
            ...
            <p className="text-sm text-gray-600 leading-relaxed max-w-xs">
              A modern image management platform crafted for creators. Upload, organize, and share your visual world with elegance and ease.
            </p>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">Features</a></li>
              ...
              <li><a href="#" className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">Changelog</a></li>
            </ul>
          </div>
          ...
          <div className="md:col-span-3">
            ...
            <ul className="space-y-3">
              <li><a href="#privacy" className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">Privacy Policy</a></li>
              <li><a href="#terms" className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">Terms of Service</a></li>
              <li><a href="#contact" className="text-sm text-gray-500 hover:text-indigo-600 transition-colors">Contact Support</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-xs text-gray-400">
            &copy; {currentYear} ImageHub Inc. All rights reserved.
          </p>
